...
在 JavaScript 中每个对象都是从`Object.prototype`对象克隆而来，但对象构造器的原型并不仅限于`Object.prototype`上，而是可以动态指向其他对象，这样一来，当对象 a 需要借用对象 b 的能力时，可以有选择性的吧对象 a 的构造器的原型指向对象 b，从而达到继承的效果。
